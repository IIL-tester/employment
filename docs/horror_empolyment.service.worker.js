...
/** @type {string} */
const OFFLINE_URL = 'horror_empolyment.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = false;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["horror_empolyment.html","horror_empolyment.js","horror_empolyment.offline.html","horror_empolyment.audio.worklet.js","horror_empolyment.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["horror_empolyment.wasm","horror_empolyment.pck"];
